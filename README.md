...
This project is a fork of [j-hc/revanced-magisk-module](https://github.com/j-hc/revanced-magisk-module). All credit for the builder, module template, and helper tooling goes to [j-hc](https://github.com/j-hc). Patches are provided by [ReVanced](https://github.com/ReVanced), [Morphe](https://github.com/MorpheApp), [Piko (crimera)](https://github.com/crimera/piko), [x-shim (inotia00)](https://gitlab.com/inotia00/x-shim), [De-Vanced (RookieEnough)](https://github.com/RookieEnough/De-Vanced), [Chiggi (durgesh0505)](https://github.com/durgesh0505/chiggi_morphe_patches), and [Paresh-Patches (Paresh-Maheshwari)](https://gitlab.com/Paresh-Maheshwari/paresh-patches).
