...
if VIVO_ROOT in s or MEDIA_ID_PREFIX in s or QUEUE_FIELD in s:
    raise SystemExit("v2 markers already present before patch")
...
root_inject = r'''
    ...
    move-result v0
    if-eqz v0, :vivo_v2_original_root
...
children_inject = r'''
    ...
    move-result v0
    if-eqz v0, :vivo_v2_original_children
...
print(f"patched queue:    {ii_path}")
print("v2 real-queue capture/render markers OK")
